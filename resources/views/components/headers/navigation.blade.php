    ...
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav ms-auto">
          <a class="nav-link text-dark px-xl-3">Hosting</a>
          <a class="nav-link text-dark px-xl-3">Domain</a>
          <a class="nav-link text-dark px-xl-3">Server</a>
          <a class="nav-link text-dark px-xl-3">Website</a>
          <a class="nav-link text-dark px-xl-3">Afiliasi</a>
          <a class="nav-link text-dark px-xl-3">Promo</a>
